    ...
    return (
      <div className="header-background">
        ...
        <div className="nav-bar">
          ...
          {/* Examination nav */}
          <div className="dropdown">
            <span className="nav-item-active">Exam</span>
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-content">
              <Link className="dropdown-text" to="teacher/addAttendence">
                Add Attendence{" "}
              </Link>
              <br />
              <Link className="dropdown-text" to="teacher/editAttendence">
                Edit Attendence{" "}
              </Link>
              <br />
              <Link className="dropdown-text" to="teacher/deleteAttendence">
                delete Attendence
              </Link>
              <br />
            </div>
      ...
      <div className="nav-bar">
        ...
        <div className="dropdown">
          ...
          <div className="dropdown-content">
            ...
            <br />
            <Link className="dropdown-text" to="/teacher/report">
              Report
            </Link>
          </div>
        </div>
