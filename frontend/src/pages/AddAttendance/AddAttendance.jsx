...
export default function AddAttendance(){
    ...
    function sendData(e){
        ...
        axios.post("http://localhost:5000/attendance/add", newStudent).then(()=>{
                ...
                <div >
                    <form  onSubmit={sendData}>
                        <div className="form-row">
                            ...
                            <div className="value">
                                <input className="input--style-6" type="text" required
                                onChange={(e)=>{
                        ...
                        <div className="form-row">
                            ...
                            <div className="value">
                                <input className="input--style-6" type="date" required
                                onChange={(e)=>{
                        ...
                        <div className="card-footer">
                            <button className="btn btn--radius-2 btn--blue-2" type="submit">Submit</button>
                        </div>
                    </form>
                </div>
